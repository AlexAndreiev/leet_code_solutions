...
public class FindTheSafestPathInAGrid_2812 {
    ...
    public int maximumSafenessFactor(List<List<Integer>> grid) {
        ...
        var multiSourceQueue = new LinkedList<int[]>();
        ...
        while (!multiSourceQueue.isEmpty()) {
            ...
            while (size-- > 0) {
                var curr = multiSourceQueue.poll();
                // Check neighboring cells
                for (var d : dir) {
                    var di = curr[0] + d[0];
                    var dj = curr[1] + d[1];
                    var val = mat[curr[0]][curr[1]];
...
//        }
//
//        var traversalQueue = new LinkedList<int[]>();
